...
# Starter HK-brokerage evaluator config (DESIGN.md Phase 2). These aliases
# keep the seed output and existing references stable.
SEED_CRITERIA = DEFAULT_EVAL_CRITERIA
SEED_FIELDS = DEFAULT_EXTRACTION_FIELDS
